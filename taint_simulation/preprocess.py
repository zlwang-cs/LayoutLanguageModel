    ...
    with open(
        ...
        for file in os.listdir(args.data_dir):
            ...
            with open(file_path, "r", encoding="utf8") as f:
                data = json.load(f)
            if args.pollute == 'taint':
                data = taint(data, ratio=args.taint_ratio)
            elif args.pollute == 'tear':
                data = tear(data, n_split=2)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pollute", choices=["taint", "tear", "clean"], default="clean")
    parser.add_argument("--data_split", type=str, default="train")
    parser.add_argument("--output_dir", type=str, default="data")
    parser.add_argument("--model_name_or_path", type=str, default="bert-base-uncased")
    parser.add_argument("--max_len", type=int, default=510)
    parser.add_argument("--taint_ratio", type=float, default=0.1)
...
python3 preprocess.py --data_dir /data4/jiayun/FUNSD/dataset/training_data/annotations \
                                    --data_split train \
                                    --pollute taint \
                                    --output_dir /data4/jiayun/FUNSD/taint \
                                    --model_name_or_path bert-base-uncased \
                                    --max_len 510

python3 preprocess.py --data_dir /data4/jiayun/FUNSD/dataset/testing_data/annotations \
                                    --data_split test \
                                    --pollute taint \
                                    --output_dir /data4/jiayun/FUNSD/taint \
                                    --model_name_or_path bert-base-uncased \
...
cat /data4/jiayun/FUNSD/taint/train.txt | cut -d$'\t' -f 2 | grep -v "^$"| sort | uniq > /data4/jiayun/FUNSD/taint/labels.txt
'''
...
python3 preprocess.py --data_dir /data4/jiayun/FUNSD/dataset/training_data/annotations \
                                    --data_split train \
                                    --pollute clean \
                                    --output_dir /data4/jiayun/FUNSD/clean \
                                    --model_name_or_path bert-base-uncased \
                                    --max_len 510
...
cat /data4/jiayun/FUNSD/clean/train.txt | cut -d$'\t' -f 2 | grep -v "^$"| sort | uniq > /data4/jiayun/FUNSD/clean/labels.txt
'''
